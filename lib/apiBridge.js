...
ApiBridge.prototype.sendRequest = function (endpoint, method, data, callback) {
	...
	if ($('body').hasClass('panel')) {
		...
		var request = { "endpoint": this.localStorageHandler.getActiveEndpointAddress() + endpoint, "method": method, "data": data};
		...
		xhr.open(method, this.localStorageHandler.getActiveEndpointAddress() + endpoint, true);
